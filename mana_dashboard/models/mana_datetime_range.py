...
class ManaDashboardDatetimeRangeBase(models.Model):
    ...
    start_time = fields.Datetime(string='Start Time', compute='_compute_time')
    end_time = fields.Datetime(string='End Time', compute='_compute_time')

    previous_start_time = fields.Datetime(string='Previous Start Time', compute='_compute_time')
    previous_end_time = fields.Datetime(string='Previous End Time', compute='_compute_time')
